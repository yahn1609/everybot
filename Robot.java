...
public class Robot extends TimedRobot {
  ...
   */
  CANSparkMax m_launchWheel = new CANSparkMax(8, MotorType.kBrushed); // this if for shooting dont forget to label and give id 
  CANSparkMax m_feedWheel = new CANSparkMax(7, MotorType.kBrushed); // this if for intake dont for get to label and give id
 ...
 /**
  ...
  public void teleopPeriodic() {
    ...
    else if(m_manipController.getRawButtonReleased(5)) // spins up launcher wheel which is lb
    {
      m_feedWheel.set(0);
    }
    ...
    {
      m_launchWheel.set(FEEDER_OUT_SPEED);                        // need to see what raw button 6 is
    }
    ...
    else if(m_manipController.getRawButtonReleased(1)) //1 for both motors
    {
      m_feedWheel.set(0);
      m_launchWheel.set(0);
    }
